...
contract HordeChurch is Ownable, ERC721Enumerable {
    ...
    event welcomeToHordeChurch(uint256 indexed id);
    ...
    constructor(string memory baseURI) ERC721("HordeChurch", "Church") {
        setBaseURI(baseURI);
    }
        ...
        saleIsOpen
    {
        ...
        emit welcomeToHordeChurch(tokenId);
    }
