...
contract HordeWasteland is Ownable, ERC721Enumerable {
    ...
    event welcomeToHordeWasteland(uint256 indexed id);
    ...
    constructor(string memory baseURI) ERC721("HordeWasteland", "WLAND") {
        setBaseURI(baseURI);
    }
        ...
        saleIsOpen
    {
        ...
        emit welcomeToHordeWasteland(tokenId);
    }
